...
const app = express();
const pool=new pg({host:'ec2-54-247-78-30.eu-west-1.compute.amazonaws.com',database:'d6jr3m7mctkfhk',user:'ddxgptueydmsbd',password:'0e51f65e01db670a9d053f3849e97c3739cfd2e2cb434cdfa0dbd26fccd2dc36',port:'5432',ssl:{rejectUnauthorized:false}});
